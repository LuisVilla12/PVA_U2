...
class MosaicScreen extends StatefulWidget {
  static const String name = 'MosaicScreen';
...
class _MosaicScreenState extends State<MosaicScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Mosaic filter')),
      body: SafeArea(
        child: Padding(
                  ...
                  ImageSelectorWidget(
                    onImageSelected: (path) async {
                      ...
                      try {
                        ...
                        final Uint8List? bytes = await UploadService.uploadImage('/mosaic', path, ksize: ksize);
                        ...
                        showDialog(
                          ...
                          builder: (_) => AlertDialog(
                            title: Text('Preview mosaic (ksize=$ksize)'),
                            ...
                            actions: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  try {
                                    await UploadService.saveImageBytes(bytes, 'mosaic.png');
