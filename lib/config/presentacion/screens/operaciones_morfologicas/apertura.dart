...
class AperturaScreen extends StatefulWidget {
  static const String name = 'AperturaScreen';
                  ...
                  ImageSelectorWidget(
                    onImageSelected: (path) async {
                      ...
                      try {
                        ...
                        final Uint8List? bytes = await UploadService.uploadImage('/apertura', path, ksize: ksize);
                        ...
                        showDialog(
                          ...
                          builder: (_) => AlertDialog(
                            title: Text('Preview Apertura (ksize=$ksize)'),
                            ...
                            actions: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  try {
                                    await UploadService.saveImageBytes(bytes, 'apertura.png');
