...
class DilatacionScreen extends StatefulWidget {
  static const String name = 'DilatacionScreen';
  const DilatacionScreen({super.key});

  @override
  State<DilatacionScreen> createState() => _DilatacionScreenState();
}

class _DilatacionScreenState extends State<DilatacionScreen> {
  int ksize = 5;
                  ...
                  ImageSelectorWidget(
                    onImageSelected: (path) async {
                      ...
                      try {
                        ...
                        final Uint8List? bytes = await UploadService.uploadImage('/dilatacion', path, ksize: ksize);
                        ...
                        showDialog(
                          ...
                          builder: (_) => AlertDialog(
                            title: Text('Preview Dilatación (ksize=$ksize)'),
                            ...
                            actions: [
                              IconButton(
                                ...
                                onPressed: () async {
                                  try {
                                    await UploadService.saveImageBytes(bytes, 'dilatacion.png');
